...
function App() {
  ...
  return (
    ...
    <Routes>
      ...
      <Route exact path='/model3' element={<Model3 currentModel='model3' setResponse={setResponse} desc={desc3} heading={heading3} numberOfQuestions={numberOfQuestions} setnumberOfQuestions={setnumberOfQuestions} endpoint="model3"/>}/>
