...
export class Navbar extends Component {
  render() {
    return (
      <div className='main-nav' style={{fontFamily:'Arial',backgroundColor:'transparent',padding:'6px',height:'45px',color:'black',display:'flex',justifyContent:'space-around',backdropFilter:'blur(10px)',borderBottom:'1px solid black',position:'fixed',zIndex:'100',top:0,bottom:0,left:0,right:0}}>
          ...
          <div className='third-div' style={{display:'flex',paddingTop:'20px',alignItems:'center',justifyContent:'flex-start',marginLeft:'30px',whiteSpace:'nowrap'}}>
              <div className='third-div' style={{position:'relative',display:'flex',justifyContent:'right',paddingRight:'40px'}}>
                <p className='third-nav-property' style={{paddingRight:'75px'}}> Works with</p>
